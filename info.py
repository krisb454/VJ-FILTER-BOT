...
API_ID = int(environ.get('API_ID', '26256991'))
API_HASH = environ.get('API_HASH', 'f4c9290d6fe9fe266d8fedee6000a82a')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002359228295'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6187925452').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002250914485').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '1001883953052') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shivamycck:<db_5tO5F0ur0aisa0Og>@cluster0.7het7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Shikamaaru_naara') # owner username without @
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movie_dissucison')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/movie_dissucison')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/movie_dissucison')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'movie_dissucison) # Support Chat Link Without https:// or @
